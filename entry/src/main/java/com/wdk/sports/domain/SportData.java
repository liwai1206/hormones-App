...
public class SportData implements Serializable {
    ...
    private int average_heart;// 平均心率
    ...
    public SportData(String device_id, String device_type, String mode, int counts, int frequency, int interrupt_count, float average_speed, int average_range, int rotation_counts, int average_heart, float calories, String time, int duration, String ext_msg) {
